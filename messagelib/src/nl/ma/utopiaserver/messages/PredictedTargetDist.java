 ...
 */
public class PredictedTargetDist implements UtopiaMessage {
    public static final int MSGID         =(int)'F';
    public static final String MSGNAME    ="PREDICTEDTARGETDIST";
    /**
    ...
    public int[] objIDs;
    /**
     * The probability this objID is the target
     */
    public float[] pTgt;

    public PredictedTargetDist(final int timeStamp, final int objIDs, final float pTgt){
     ...
     */ 
    public static PredictedTargetDist deserialize(final ByteBuffer buffer, int version)
       ...
       int size = nObjects * (1+4); // byte + float
       ...
       return new PredictedTargetDist(timeStamp,objIDs,pTgt);
    }
    public static PredictedTargetDist deserialize(final ByteBuffer buffer)
        throws ClientException {
